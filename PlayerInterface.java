 ...
 * After each chooseShot method the game will inform the player of the result of the shot
 * with the shotResult method.
 * The player will also be informed of opponent's shots with the opponentShot method.
 * This could be used to update a local copy of the game board for display to the user.
 * 
 */
